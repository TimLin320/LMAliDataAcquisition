...
(function(){
  try{
    var tempValue = function(){};
     if(window.mtopjsonp1 !== undefined){
        var oldMethod = window.mtopjsonp1;
         window.mtopjsonp1 = function(){
             var args = Array.prototype.slice.call(arguments);
             window.webkit && window.webkit.messageHandlers &&
             window.webkit.messageHandlers.fetchAliOrdersData.postMessage(args[0])
